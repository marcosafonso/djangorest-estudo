    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('family', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='demoapp.Family')),
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='demoapp.Location')),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='demoapp.Product')),
            ],
        ),
    ]
